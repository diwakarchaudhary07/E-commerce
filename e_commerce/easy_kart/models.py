...
class Product(models.Model):
    ...
    size = models.CharField(max_length=100, blank=True, null=True, help_text='Product size (e.g., S, M, L, XL or 10cm x 10cm)')
    shape = models.CharField(max_length=100, blank=True, null=True, help_text='Product shape (e.g., Square, Round, Rectangular)')
    weight = models.CharField(max_length=100, blank=True, null=True, help_text='Product weight (e.g., 500g, 1kg, 2lbs)')
    is_active = models.BooleanField(default=True)
    created_at = models.DateTimeField(auto_now_add=True)
    updated_at = models.DateTimeField(auto_now=True)
